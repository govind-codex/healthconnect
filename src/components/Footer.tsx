...
const Footer: React.FC = () => {
  return (
    <footer className="py-8 px-6 flex flex-col items-center justify-center text-center">
      <motion.div 
      ...
      >
        ...
        <div className="flex items-center gap-6">
          ...
          >
            ...
            <span className="text-[8px] uppercase font-black tracking-widest text-slate-400 group-hover:text-slate-900 transition-colors">GitHub</span>
          </a>
          ...
          >
            ...
            <span className="text-[8px] uppercase font-black tracking-widest text-slate-400 group-hover:text-blue-600 transition-colors">LinkedIn</span>
          </a>
        </div>
